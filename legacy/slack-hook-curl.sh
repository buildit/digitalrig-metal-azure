curl -u ***REMOVED***:***REMOVED*** https://dev.azure.com/rigtest/_apis/hooks/subscriptions?api-version=5.0 -H "Accept: application/json" -H "Content-type: application/json" -X POST -d '{
    "status": "enabled",
    "publisherId": "tfs",
